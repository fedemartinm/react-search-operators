...
const IntroductionExample = App
IntroductionExample.title = 'Simple usage'
IntroductionExample.description =
  "Search component for react. It's allows you to process search terms " +
  'and filters before a request. Try using one of these operators: +exact ' +
  '-exclude "exact phrase".'
IntroductionExample.source =
  'https://github.com/fedemartinm/react-search-operators/blob/master/example/src/Examples/Introduction/'
